...
> **Scan Window**: {{SCAN_WINDOW_START}} ~ {{SCAN_WINDOW_END}}
> **Anchor Time (T₀)**: {{SCAN_ANCHOR_TIMESTAMP}}
> **Per-Workflow Scan Range**: WF1 {{WF1_LOOKBACK_HOURS}} hours | WF2 {{WF2_LOOKBACK_HOURS}} hours | WF3 {{WF3_LOOKBACK_HOURS}} hours | WF4 {{WF4_LOOKBACK_HOURS}} hours
...
- **WF1 (General Environmental Scanning)**: {{WF1_TOTAL_SIGNALS}} signals collected
- **WF2 (arXiv Academic Deep Scan)**: {{WF2_TOTAL_SIGNALS}} signals collected
- **WF3 (Naver News)**: {{WF3_TOTAL_SIGNALS}} signals collected
- **WF4 (Multi&Global-News)**: {{WF4_TOTAL_SIGNALS}} signals collected
- **Integrated Signal Pool**: {{TOTAL_COMBINED_SIGNALS}}
...
|------|-----------|-------------|-------------|-------------|------|
| Source Count | {{WF1_SOURCE_COUNT}} | 1 (arXiv) | 1 (NaverNews) | {{WF4_SOURCE_COUNT}} | {{TOTAL_SOURCE_COUNT}} |
| Collected Signals | {{WF1_SIGNAL_COUNT}} | {{WF2_SIGNAL_COUNT}} | {{WF3_SIGNAL_COUNT}} | {{WF4_SIGNAL_COUNT}} | {{TOTAL_SIGNAL_COUNT}} |
| After Dedup | {{WF1_DEDUP_COUNT}} | {{WF2_DEDUP_COUNT}} | {{WF3_DEDUP_COUNT}} | {{WF4_DEDUP_COUNT}} | {{TOTAL_DEDUP_COUNT}} |
| Top Signals | {{WF1_TOP_COUNT}} | {{WF2_TOP_COUNT}} | {{WF3_TOP_COUNT}} | {{WF4_TOP_COUNT}} | 20 |
| Avg pSST | {{WF1_AVG_PSST}} | {{WF2_AVG_PSST}} | {{WF3_AVG_PSST}} | {{WF4_AVG_PSST}} | {{TOTAL_AVG_PSST}} |
| Execution Time | {{WF1_DURATION}} | {{WF2_DURATION}} | {{WF3_DURATION}} | {{WF4_DURATION}} | {{TOTAL_DURATION}} |
