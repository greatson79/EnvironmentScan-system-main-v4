...
> **Scan Window**: March 05, 2026 00:12 UTC ~ March 06, 2026 00:12 UTC (24 hours)
> **Anchor Time (T₀)**: March 06, 2026 00:12:22 UTC
...
### Key Changes Summary
- New signals detected: 42
- Top priority signals: 28
- Major impact domains: {{DOMAIN_DISTRIBUTION}}

### Crawling Statistics Summary
- Sites crawled: 1 sites, 1 succeeded, 0 failed
- Language breakdown: 17 Korean, 20 English, 2 Chinese, 1 Japanese, 1 German, 1 French, 1 Russian, 1 Other
- Translation: 24 translated, 0 failed
...
|-----------|---------|----------|
| RED | 8 | U.S. and Israel Strike Iran Overnight, Targeting Ballistic Missile Sites, Strait of Hormuz Traffic Drops 90% as Iran Blockade Disrupts Global Oil Supply, US Submarine Sinks Iranian Warship in Indian Ocean, 87 Dead and 5 |
| ORANGE | 5 | Kurdish Militias Form Coalition, Position Thousands of Fighters Along Iran-Iraq Border, China Moves to Halt Fuel Exports as Gulf Supply Tightens, Putin Floats Cutting Europe Gas Sales, Redirecting to Premium Asian Markets and 2 |
| YELLOW | 11 | Senate Blocks Bid to Limit Trump's Iran War Powers, 53-47, Spain Rejects White House Claim of Iran War Support, Bars Use of Military Bases, China Sets Lowest Growth Target in Decades at 4.5-5% for 2026 and 8 |
| GREEN | 18 | France and Germany Pledge Energy Policy Alignment for European Grid Integration, Korea Triples AI Budget to 10.1 Trillion Won, Targets Top-3 AI Power Status, FDA Grants Breakthrough Designation to Generative AI Chatbot for Surgical Patients and 15 |
...
|-----------|---------|-----------|-----------|
| Weak Signal | 6 | {{FSSF_DIST_WS_REPR}} | {{FSSF_DIST_WS_NOTE}} |
| Emerging Issue | 8 | {{FSSF_DIST_EI_REPR}} | {{FSSF_DIST_EI_NOTE}} |
| Trend | 8 | {{FSSF_DIST_TR_REPR}} | {{FSSF_DIST_TR_NOTE}} |
| Megatrend | 1 | {{FSSF_DIST_MT_REPR}} | {{FSSF_DIST_MT_NOTE}} |
| Driver | 6 | {{FSSF_DIST_DR_REPR}} | {{FSSF_DIST_DR_NOTE}} |
| Wild Card | 3 | {{FSSF_DIST_WC_REPR}} | {{FSSF_DIST_WC_NOTE}} |
| Discontinuity | 6 | {{FSSF_DIST_DC_REPR}} | {{FSSF_DIST_DC_NOTE}} |
| Precursor Event | 4 | {{FSSF_DIST_PE_REPR}} | {{FSSF_DIST_PE_NOTE}} |
...
| Total Sites Crawled | 1 |
| Sites Succeeded | 1 |
| Sites Failed | 0 |
| Total Articles Collected | 44 |
| S/N Ratio | 44:44 |
...
| By Language — Korean | 17 |
| By Language — English | 20 |
| By Language — Chinese | 2 |
| By Language — Japanese | 1 |
| By Language — German | 1 |
| By Language — French | 1 |
| By Language — Russian | 1 |
| By Language — Other | 1 |
