...
- Top priority signals: 11
- Major impact domains: Political(P) 8, Economic(E) 7, Technological(T) 4, Environmental(E) 1

### Crawling Statistics Summary
- Sites crawled: 1 sites, 1 succeeded, 0 failed
- Language breakdown: 0 Korean, 17 English, 0 Chinese, 1 Japanese, 0 German, 2 French, 0 Russian, 0 Other
- Translation: 3 translated, 0 failed
...
|-----------|---------|----------|
| GREEN | 20 | Israel Launches Broad Wave of Strikes in Tehran Amid US-Iran War Escalation, South Korea KOSPI Suffers Historic 12% Crash Amid Hormuz Strait Blockade, Global Oil Prices Surge Toward $100 as Strait of Hormuz Traffic Halts and 17 |
...
| Emerging Issue | 5 | {{FSSF_DIST_EI_REPR}} | {{FSSF_DIST_EI_NOTE}} |
| Trend | 4 | {{FSSF_DIST_TR_REPR}} | {{FSSF_DIST_TR_NOTE}} |
| Megatrend | 2 | {{FSSF_DIST_MT_REPR}} | {{FSSF_DIST_MT_NOTE}} |
| Driver | 1 | {{FSSF_DIST_DR_REPR}} | {{FSSF_DIST_DR_NOTE}} |
| Wild Card | 1 | {{FSSF_DIST_WC_REPR}} | {{FSSF_DIST_WC_NOTE}} |
| Discontinuity | 1 | {{FSSF_DIST_DC_REPR}} | {{FSSF_DIST_DC_NOTE}} |
| Precursor Event | 3 | {{FSSF_DIST_PE_REPR}} | {{FSSF_DIST_PE_NOTE}} |
