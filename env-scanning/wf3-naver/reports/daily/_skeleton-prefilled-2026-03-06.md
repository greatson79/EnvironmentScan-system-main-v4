...
### Key Changes Summary
- New signals detected: 257
- Top priority signals: 68
...
|-----------|---------|----------|
| RED | 6 | 하메네이 사살 뒤 드론·미사일 빗발… 중동 전역 사이렌 [박수찬의 軍], 호르무즈 봉쇄에…유조선 통과 하루 50척→0척, 유조선 통과 하루 50척→0척…호르무즈 '기름길' 막혔다 and 3 |
| ORANGE | 8 | 북, '최현호' 전략순항미사일 시험발사…김정은 "해군 핵무장화 만족"(종합), 주한미군 미사일까지 빼내나‥패트리엇 이동?, 강보합 전환도 잠시…코스피, 다시 밀리며 변동성 확대 and 5 |
| YELLOW | 14 | 2월 소비자물가 2.0% 상승…'중동 사태' 유가상승 반영은 아직, [속보] 유가 급등에 코스피, 하락 출발…코스닥은 '상승', 유가 80불 돌파..."이란전쟁 길어지나" 미 증시 하루만에 '뚝'[뉴욕마감] and 11 |
| GREEN | 229 | 박찬대 "연수갑 만만찮은 곳, 김남준 오면 고전…송영길? 인지도도 높고", 박수현 민주당 수석대변인 충남도지사 출마 위해 사임, 구윤철 “기름값 폭리엔 무관용 원칙”…정부, 주유소 현장 점검 착수 and 226 |
...
|-----------|---------|-----------|-----------|
| Weak Signal | 24 | {{FSSF_DIST_WS_REPR}} | {{FSSF_DIST_WS_NOTE}} |
| Emerging Issue | 13 | {{FSSF_DIST_EI_REPR}} | {{FSSF_DIST_EI_NOTE}} |
| Trend | 118 | {{FSSF_DIST_TR_REPR}} | {{FSSF_DIST_TR_NOTE}} |
| Megatrend | 0 | {{FSSF_DIST_MT_REPR}} | {{FSSF_DIST_MT_NOTE}} |
| Driver | 11 | {{FSSF_DIST_DR_REPR}} | {{FSSF_DIST_DR_NOTE}} |
| Wild Card | 67 | {{FSSF_DIST_WC_REPR}} | {{FSSF_DIST_WC_NOTE}} |
| Discontinuity | 10 | {{FSSF_DIST_DC_REPR}} | {{FSSF_DIST_DC_NOTE}} |
| Precursor Event | 14 | {{FSSF_DIST_PE_REPR}} | {{FSSF_DIST_PE_NOTE}} |
