...
|-----------|---------|----------|
| GREEN | 36 | 천하람, 박홍근 '전과 사면' 허위기재 의혹…“자진 사퇴해야”, 北 핵무력 강화에…李 "자주국방이 통합방위의 핵심", 이정현 “3당합당·DJP연합도 위기 속 결정...당 대표엔 마음 무거워” and 33 |
...
| Trend | 17 | {{FSSF_DIST_TR_REPR}} | {{FSSF_DIST_TR_NOTE}} |
| Megatrend | 0 | {{FSSF_DIST_MT_REPR}} | {{FSSF_DIST_MT_NOTE}} |
| Driver | 1 | {{FSSF_DIST_DR_REPR}} | {{FSSF_DIST_DR_NOTE}} |
| Wild Card | 18 | {{FSSF_DIST_WC_REPR}} | {{FSSF_DIST_WC_NOTE}} |
